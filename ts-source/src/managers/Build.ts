...
export class BuildManager extends Manager {
    ...
    public readonly MEMORY_LASTRUN_DISMANTLE = "lastRunDismantle";
    public readonly MEMORY_LASTRUN_BUILD = "lastRunBuild";
    public readonly MEMORY_LASTRUN_ORDER = "lastRunOrder";
