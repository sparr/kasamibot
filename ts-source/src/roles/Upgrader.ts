export function run(creep: Creep) {
    let controller = Game.getObjectById(creep.memory.target) as Controller;
    ...
    let container = Game.getObjectById(creep.memory.container) as Link | Container;
    if (container === null) {
...
function setUpgraderPos(creep: Creep, around: RoomPosition) {
